...
#define ALSPS_IOCTL_SET_CALI                _IOR(ALSPS, 0x0a, int)
#define ALSPS_SET_PS_PCOUNT                 _IOR(ALSPS, 0x0b, int)
#define ALSPS_SET_PS_POFFSET                 _IOR(ALSPS, 0x0c, int)  /*Colby add 20121218*/
