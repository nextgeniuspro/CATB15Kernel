	...
	else if(pmic_type == MT65XX_LED_PMIC_LCD_BOOST)
	{
		...
		*/		
		if (level) 
		{
            ...
            printk("[BKL]%s, mapped backlight level = %d\n", __func__, level);
			...
			switch(level)
			{
                                case 0:
                                        ...
                                        hwPWMsetting(PMIC_PWM_0, 2, 0x09);
                                        break;
                                case 1:
                                        upmu_boost_vrsel(0x3);
                                        hwPWMsetting(PMIC_PWM_0, 4, 0x09);
                                        break;
                                case 2:
                                        upmu_boost_vrsel(0x4);
                                        hwPWMsetting(PMIC_PWM_0, 5, 0x09);
                                        break;
                                case 3:
                                        upmu_boost_vrsel(0x5);
                                        hwPWMsetting(PMIC_PWM_0, 6, 0x09);
                                        break;
                                case 4:
                                        upmu_boost_vrsel(0x6);
                                        hwPWMsetting(PMIC_PWM_0, 7, 0x09);
                                        break;
                                case 5:
                                        upmu_boost_vrsel(0x7);
                                        hwPWMsetting(PMIC_PWM_0, 9, 0x09);
                                        break;
                                case 6:
                                        upmu_boost_vrsel(0x8);
                                        hwPWMsetting(PMIC_PWM_0, 10, 0x09);
                                        break;
                                case 7:
                                        upmu_boost_vrsel(0x8);
                                        hwPWMsetting(PMIC_PWM_0, 12, 0x09);
                                        break;
                                case 8:
                                ...
                                case 10:
                                        upmu_boost_vrsel(0xA);
                                        hwPWMsetting(PMIC_PWM_0, 13, 0x09);
                                        break;
                                case 11:
                                ...
                                case 12:
                                        ...
                                        break;
                                case 13:
                                        upmu_boost_vrsel(0xD);
                                        hwPWMsetting(PMIC_PWM_0, 13, 0x09);
                                        break;
                                case 14:
                                        upmu_boost_vrsel(0xA);
                                        hwPWMsetting(PMIC_PWM_0, 15, 0x09);
                                        break;
                                case 15:
                                        upmu_boost_vrsel(0xC);
                                        hwPWMsetting(PMIC_PWM_0, 15, 0x09);
