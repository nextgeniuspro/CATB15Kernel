...
BATTERY_PROFILE_STRUC_P fgauge_get_profile(kal_uint32 temperature)
{
	...
	else
	{
        ...
        {
            case TEMPERATURE_T0:
                return &battery_profile_t0[0]; //TODO:replace return &battery_profile_t0_new[0];
                break;    
            case TEMPERATURE_T1:
                return &battery_profile_t1[0]; //TODO:replace return &battery_profile_t1_new[0];
                break;
            case TEMPERATURE_T2:
                return &battery_profile_t2[0]; //TODO:replace return &battery_profile_t2_new[0];
                break;
            case TEMPERATURE_T3:
                return &battery_profile_t3[0]; //TODO:replace return &battery_profile_t3_new[0];
                break;
            case TEMPERATURE_T:
                return &battery_profile_temperature[0]; //TODO:replace return &battery_profile_temperature_new[0];
                break;
            default:
                return NULL;
                break;
...
R_PROFILE_STRUC_P fgauge_get_profile_r_table(kal_uint32 temperature)
{
	...
	else
	{
        ...
        {
            case TEMPERATURE_T0:
                return &r_profile_t0[0];    // TODO: remove all new
                break;
            case TEMPERATURE_T1:
                return &r_profile_t1[0];
                break;
...
kal_int32 fgauge_get_Q_max(kal_int16 temperature)
{
    ...
    if (temperature <= TEMPERATURE_T1)
    {
		...
		{
            low_temperature = (-10);
            low_Q_max = Q_MAX_NEG_10;   // TODO: remove new
            high_temperature = TEMPERATURE_T1;
            high_Q_max = Q_MAX_POS_0;   // TODO: remove new
		}
        if(temperature < low_temperature)
        {
            temperature = low_temperature;
    ...
    else if (temperature <= TEMPERATURE_T2)
    {
		...
		{
            low_temperature = TEMPERATURE_T1;
            low_Q_max = Q_MAX_POS_0;    // TODO: remove new
            high_temperature = TEMPERATURE_T2;
            high_Q_max = Q_MAX_POS_25;  // TODO: remove new
    ...
    else
    {
		...
		{
            low_temperature  = TEMPERATURE_T2;
            low_Q_max = Q_MAX_POS_25;   // TODO: remove new
            high_temperature = TEMPERATURE_T3;
            high_Q_max = Q_MAX_POS_50;  // TODO: remove new
		}
        if(temperature > high_temperature)
        {
            temperature = high_temperature;
...
kal_int32 fgauge_get_Q_max_high_current(kal_int16 temperature)
{
    ...
    if (temperature <= TEMPERATURE_T1)
    {
		...
		{
            low_temperature = (-10);
            low_Q_max = Q_MAX_NEG_10_H_CURRENT; // TODO: remove new
            high_temperature = TEMPERATURE_T1;
            high_Q_max = Q_MAX_POS_0_H_CURRENT; // TODO: remove new
		}
        if(temperature < low_temperature)
        {
            temperature = low_temperature;
    ...
    else if (temperature <= TEMPERATURE_T2)
    {
		...
		{
            low_temperature = TEMPERATURE_T1;
            low_Q_max = Q_MAX_POS_0_H_CURRENT;  // TODO: remove new
            high_temperature = TEMPERATURE_T2;
            high_Q_max = Q_MAX_POS_25_H_CURRENT;    // TODO: remove new
		}
        if(temperature < low_temperature)
        {
            temperature = low_temperature;
    ...
    else
    {
		...
		{
            low_temperature  = TEMPERATURE_T2;
            low_Q_max = Q_MAX_POS_25_H_CURRENT; // TODO: remove new
            high_temperature = TEMPERATURE_T3;
            high_Q_max = Q_MAX_POS_50_H_CURRENT;    // TODO: remove new
...
//#if 0
    ...
    if (cci_platform_is_dvt()||cci_platform_is_pvt()||cci_platform_is_pvt_sc())
    {
        CCINewBatteryFG=0;
		printk("CCINewBattery=%d\n",CCINewBatteryFG);
		printk("cci_platform_is_pvt_sb=%d\ncci_platform_is_pvt_sb_sc=%d\n",cci_platform_is_pvt_sb(),cci_platform_is_pvt_sb_sc());
    }
	else
	{
	    CCINewBatteryFG=1;
