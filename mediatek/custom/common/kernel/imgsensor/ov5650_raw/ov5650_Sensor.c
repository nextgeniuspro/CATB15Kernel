  ...
  if((30 == u2FrameRate)||(15 == u2FrameRate))
  	{
		...
		{
			dummy_lines = (kal_uint16)((OV5650_g_fCP_PCLK/u2FrameRate)/(OV5650_QXGA_MODE_WITHOUT_DUMMY_PIXELS+OV5650_iDummypixels));      
			dummy_lines = dummy_lines - OV5650_QXGA_MODE_WITHOUT_DUMMY_LINES;
		}
		else
		{
