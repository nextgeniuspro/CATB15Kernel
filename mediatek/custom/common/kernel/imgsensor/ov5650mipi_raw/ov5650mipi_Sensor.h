...
//    extern SensorInfo OV5650MIPI_g_CCT_MainSensor;
  //  extern kal_uint8 OV5650MIPI_g_CCT_FirstGrabColor;
    ...
    #define OV5650MIPI_IMAGE_SENSOR_FULL_WIDTH     (2600)//(2592) // (2584)
    #define OV5650MIPI_IMAGE_SENSOR_FULL_HEIGHT    (1948)//(1944) //(1944)

    // sensor's full resolution
    #define OV5650MIPI_IMAGE_SENSOR_FULL_WIDTH_DRV     (2560)//(2592 - 2 - (OV5650MIPI_ISP_INTERPOLATIO_FILTER_WIDTH - 1)) 
    #define OV5650MIPI_IMAGE_SENSOR_FULL_HEIGHT_DRV    (1920)//(1944 - 2 - (OV5650MIPI_ISP_INTERPOLATIO_FILTER_HEIGHT - 1)) 
...
//define OV5650MIPI_USE_OTP

#if defined(OV5650MIPI_USE_OTP)

struct OV5650MIPI_otp_struct
{
