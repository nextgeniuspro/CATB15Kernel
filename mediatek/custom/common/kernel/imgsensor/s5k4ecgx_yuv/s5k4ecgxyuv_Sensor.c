...
static void S5K4ECGX_FOCUS_Init(void);
#endif
...
{
//    UINT8 state=0x8F;
//    UINT32 iteration = 100; //time out

    SENSORDB("S5K4ECGX_FOCUS_Init\n");     
// AF interface
    S5K4ECGX_write_cmos_sensor(0x0028, 0x7000);
    S5K4ECGX_write_cmos_sensor(0x002A, 0x01FC);
    S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000);	//#REG_TC_IPRM_LedGpio								// No LED GPIO
    S5K4ECGX_write_cmos_sensor(0x002A, 0x1720);
    S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000);	//#afd_usFlags, Low voltage AF enable 
    S5K4ECGX_write_cmos_sensor(0x002A, 0x01FE);
    ...
    S5K4ECGX_write_cmos_sensor(0x002A, 0x020C);
    S5K4ECGX_write_cmos_sensor(0x0F12, 0x2F0C);	//#REG_TC_IPRM_CM_Init_Mi2cBits 			//[11:10] SDA [9:8]SCL	0000 - 1,2 / 0101 - 3,4 / 1010 - 5,6 / 1111 - 7,8//2F0C
...
// AF param
  //AF window
    ...
    S5K4ECGX_write_cmos_sensor(0x0F12, 0x01C6);	//#REG_TC_AF_ScndWinStartX
    S5K4ECGX_write_cmos_sensor(0x0F12, 0x0166);	//#REG_TC_AF_ScndWinStartY
    S5K4ECGX_write_cmos_sensor(0x0F12, 0x0074);	//#REG_TC_AF_ScndWinSizeX
  ...
  // 2nd search setting
    S5K4ECGX_write_cmos_sensor(0x002A,	0x070E);
    S5K4ECGX_write_cmos_sensor(0x0F12,	0x00FF);	//#skl_af_StatOvlpExpFactor
    S5K4ECGX_write_cmos_sensor(0x002A,	0x071E);
    S5K4ECGX_write_cmos_sensor(0x0F12,	0x0000);	//#skl_af_bAfStatOff //Daniel: fix double focus issue
    S5K4ECGX_write_cmos_sensor(0x002A,	0x163C);
    S5K4ECGX_write_cmos_sensor(0x0F12,	0x0000);	//#af_search_usAeStable
    S5K4ECGX_write_cmos_sensor(0x002A,	0x1648);
    S5K4ECGX_write_cmos_sensor(0x0F12,	0x9000);	//0x9002#af_search_usSingleAfFlags //9002 TODO
    S5K4ECGX_write_cmos_sensor(0x002A,	0x1652);
    S5K4ECGX_write_cmos_sensor(0x0F12,	0x0003);	//#af_search_usFinePeakCount //2 TODO
    S5K4ECGX_write_cmos_sensor(0x0F12,	0x0000);	//#af_search_usFineMaxScale
    S5K4ECGX_write_cmos_sensor(0x002A,	0x15E0);
    S5K4ECGX_write_cmos_sensor(0x0F12,	0x0902);	//#af_pos_usFineStepNumSize //801 TODO

  // peak threshold
    S5K4ECGX_write_cmos_sensor(0x002A,	0x164C);
    S5K4ECGX_write_cmos_sensor(0x0F12,	0x0003);	//#af_search_usMinPeakSamples
    S5K4ECGX_write_cmos_sensor(0x002A,	0x163E);
    S5K4ECGX_write_cmos_sensor(0x0F12,	0x00E5);	//#af_search_usPeakThr					  //Full search  ( C0 75%)
    S5K4ECGX_write_cmos_sensor(0x0F12,	0x0098);	//#af_search_usPeakThrLow //CC TODO
  //Home Position
    S5K4ECGX_write_cmos_sensor(0x002A,	0x15D4);
  ...
  // AF statistics
    ...
    S5K4ECGX_write_cmos_sensor(0x002A,	0x15E6);
    S5K4ECGX_write_cmos_sensor(0x0F12,	0x003C);	//#af_pos_usCaptureFixedPos

//AF Param: Scan table //Table is different TODO
    S5K4ECGX_write_cmos_sensor(0x0F12,	0x000C);	//0x0018 #af_pos_usTableLastInd
    ...
    S5K4ECGX_write_cmos_sensor(0x0F12,	0x0054);	//#af_pos_usTable_7_
    S5K4ECGX_write_cmos_sensor(0x0F12,	0x005A);	//#af_pos_usTable_8_
    S5K4ECGX_write_cmos_sensor(0x0F12,	0x0060);	//#af_pos_usTable_9_
    S5K4ECGX_write_cmos_sensor(0x0F12,	0x0066);	//#af_pos_usTable_10_
    S5K4ECGX_write_cmos_sensor(0x0F12,	0x006C);	//#af_pos_usTable_11_
    S5K4ECGX_write_cmos_sensor(0x0F12,	0x0072);	//#af_pos_usTable_12_

  // VCM driver
    S5K4ECGX_write_cmos_sensor(0x002A,	0x1722);
    S5K4ECGX_write_cmos_sensor(0x0F12,	0x8000);	//#afd_usParam_0_
    S5K4ECGX_write_cmos_sensor(0x0F12,	0x0006);	//#afd_usParam_1_
    S5K4ECGX_write_cmos_sensor(0x0F12,	0x3FF0);	//#afd_usParam_2_
    S5K4ECGX_write_cmos_sensor(0x0F12,	0x03E8);	//#afd_usParam_3_
    S5K4ECGX_write_cmos_sensor(0x0F12,	0x0000);	//#afd_usParam_4_
    S5K4ECGX_write_cmos_sensor(0x0F12,	0x0100);	//#afd_usParam_5_ //80 TODO
    S5K4ECGX_write_cmos_sensor(0x0F12,	0x0009);	//#afd_usParam_6_
    S5K4ECGX_write_cmos_sensor(0x0F12,	0x0020);	//#afd_usParam_7_
    S5K4ECGX_write_cmos_sensor(0x0F12,	0x0040);	//#afd_usParam_8_
    S5K4ECGX_write_cmos_sensor(0x0F12,	0x0080);	//#afd_usParam_9_
    S5K4ECGX_write_cmos_sensor(0x0F12,	0x00C0);	//#afd_usParam_10_
    S5K4ECGX_write_cmos_sensor(0x0F12,	0x00E0);	//#afd_usParam_11_
...
UINT32 S5K4ECGXOpen(void)
{
    ...
    //Trigger AFC once
    S5K4ECGX_write_cmos_sensor(0xFCFC,0xD000);					 
    S5K4ECGX_write_cmos_sensor(0x0028,0x7000);  //TODO:??	
    S5K4ECGX_write_cmos_sensor(0x002A,0x028C);	
    S5K4ECGX_write_cmos_sensor(0x0F12,0x0006);	//REG_TC_AF_AfCmd 	0x06 : continuous
    mdelay(33);
#endif
...
static void S5K4ECGX_FOCUS_Move_to(UINT16 a_u2MovePosition)
{
//TODO
    SENSORDB("[Enter]S5K4ECGX Move_to= %d\n", a_u2MovePosition);
    S5K4ECGX_write_cmos_sensor(0x0028,0x7000);
    S5K4ECGX_write_cmos_sensor(0x002a,0x028C);
    S5K4ECGX_write_cmos_sensor(0x0f12,0x0004); // manual AF

    S5K4ECGX_write_cmos_sensor(0x002a,0x028E);
    S5K4ECGX_write_cmos_sensor(0x0f12,(a_u2MovePosition>>2)); // Set steps
}

static void S5K4ECGX_FOCUS_Get_AF_Inf(UINT32 *pFeatureReturnPara32)
{
//AF Param: inf //TODO
    *pFeatureReturnPara32 = 12;
}

static void S5K4ECGX_FOCUS_Get_AF_Macro(UINT32 *pFeatureReturnPara32)
{
//AF Param: Macro //TODO
    *pFeatureReturnPara32 = 114;
}
...
//@input zone[] addr
#define SPECIF_WIN
static void S5K4ECGX_FOCUS_Set_AF_Window(UINT32 zone_addr)
{//update global zone
    ...
    // Start_x = 1024*real_start_x/width
    // Start_y = 1024*real_start_y/height
    UINT32 width_ratio_1st, height_ratio_1st, start_x_1st, start_y_1st;  
    UINT32 width_ratio_2nd, height_ratio_2nd, start_x_2nd, start_y_2nd;  
    UINT32 center_x, center_y, half_w_1st, half_h_1st, half_w_2nd, half_h_2nd;
    ...
    FD_XS = *(zone + 4);
    FD_YS = *(zone + 5);
//    times = FD_XS / AF_XS;//TODO: what's FD_XS

#ifdef SPECIF_WIN
    width_ratio_1st =  1024*(x1 - x0)/FD_XS;
    height_ratio_1st = 1024*(y1 - y0)/FD_YS;
    width_ratio_2nd =  1024*(x1 - x0)*9/10/FD_XS; //Make 2nd window smaller than 1st window
    height_ratio_2nd = 1024*(y1 - y0)*9/10/FD_YS; //Make 2nd window smaller than 1st window
    start_x_1st = ( (x0+x1)/2 - (FD_XS*(width_ratio_1st /1024)/2) )*(1024/FD_XS);
    start_y_1st = ( (y0+y1)/2 - (FD_YS*(height_ratio_1st/1024)/2) )*(1024/FD_YS);
    start_x_2nd = ( (x0+x1)/2 - (FD_XS*(width_ratio_2nd /1024)/2) )*(1024/FD_XS);
    start_y_2nd = ( (y0+y1)/2 - (FD_YS*(height_ratio_2nd/1024)/2) )*(1024/FD_YS);
#else

    width_ratio_1st =  0x0074;
    height_ratio_1st = 0x0132;
    width_ratio_2nd =  0x0067;
    height_ratio_2nd = 0x0120;

    center_x = (x0+x1)/2;
    center_y = (y0+y1)/2;

    half_w_1st = FD_XS*(width_ratio_1st /1024)/2;
    half_h_1st = FD_YS*(height_ratio_1st/1024)/2;
    half_w_2nd = FD_XS*(width_ratio_2nd /1024)/2;
    half_h_2nd = FD_YS*(height_ratio_2nd/1024)/2;

    SENSORDB("center_x=%d,center_y=%d,half_w_1st=%d,half_h_1st=%d, half_w_2nd=%d,half_h_2nd=%d\n",
		center_x,center_y,half_w_1st,half_h_1st, half_w_2nd,half_h_2nd);	

    if(center_x <= half_w_1st){
        start_x_1st = 0;
        start_x_2nd = 2*(1024/FD_XS);
    } else if( (center_x + half_w_1st) > FD_XS){
        start_x_1st = (FD_XS - half_w_1st)*(1024/FD_XS);
        start_x_2nd = (FD_XS - half_w_1st + 2)*(1024/FD_XS);
    } else {
        start_x_1st = ( (x0+x1)/2 - (FD_XS*(width_ratio_1st /1024)/2) )*(1024/FD_XS);
        start_x_2nd = ( (x0+x1)/2 - (FD_XS*(width_ratio_1st /1024)/2) + 2 )*(1024/FD_XS);
    }

    if(center_y <= half_h_1st){
        start_y_1st = 0;
        start_y_2nd = 2*(1024/FD_YS);
    } else if( (center_y + half_h_1st) > FD_YS){
        start_y_1st = (FD_YS - half_h_1st)*(1024/FD_YS);
        start_y_2nd = (FD_YS - half_h_1st+2)*(1024/FD_YS);
    } else {
        start_y_1st = ( (y0+y1)/2 - (FD_YS*(height_ratio_1st/1024)/2) )*(1024/FD_YS);
        start_y_2nd = ( (y0+y1)/2 - (FD_YS*(height_ratio_1st/1024)/2) + 2 )*(1024/FD_YS);
    }
#endif

    SENSORDB("[Enter]Set AF window\n");
    SENSORDB("x0=%d,y0=%d,x1=%d,y1=%d,FD_XS=%d,FD_YS=%d,times=%d\n",
		x0, y0, x1, y1, FD_XS, FD_YS,times);	
    SENSORDB("start_x_1st=%d,start_y_1st=%d,width_ratio_1st=%d,height_ratio_1st=%d\n",
		start_x_1st, start_y_1st, width_ratio_1st, height_ratio_1st);	
    SENSORDB("start_x_2nd=%d,start_y_2nd=%d,width_ratio_2nd=%d,height_ratio_2nd=%d\n",
		start_x_2nd, start_y_2nd, width_ratio_2nd, height_ratio_2nd);	

    S5K4ECGX_write_cmos_sensor(0x002A,	 0x0294);
    S5K4ECGX_write_cmos_sensor(0x0F12,	     start_x_1st);	//#REG_TC_AF_FstWinStartX
    S5K4ECGX_write_cmos_sensor(0x0F12,	     start_y_1st);	//#REG_TC_AF_FstWinStartY
    S5K4ECGX_write_cmos_sensor(0x0F12,	  width_ratio_1st);	//#REG_TC_AF_FstWinSizeX
    S5K4ECGX_write_cmos_sensor(0x0F12,	 height_ratio_1st);	//#REG_TC_AF_FstWinSizeY
    S5K4ECGX_write_cmos_sensor(0x0F12,	     start_x_2nd);	//#REG_TC_AF_FstWinStartX
    S5K4ECGX_write_cmos_sensor(0x0F12,	     start_y_2nd);	//#REG_TC_AF_FstWinStartY
    S5K4ECGX_write_cmos_sensor(0x0F12,	  width_ratio_2nd);	//#REG_TC_AF_FstWinSizeX
    S5K4ECGX_write_cmos_sensor(0x0F12,	 height_ratio_2nd);	//#REG_TC_AF_FstWinSizeY
    S5K4ECGX_write_cmos_sensor(0x0F12,	 0x0001);	//#REG_TC_AF_WinSizesUpdated
    mdelay(100);
}
...
//global zone[]
static void S5K4ECGX_FOCUS_Set_AF_Window_to_IC(void)
{
    UINT8 start_x, start_y, width_ratio, height_ratio;  
	
    //Default use 15% of view
    width_ratio = 1024*0.15;
    height_ratio = 1024*0.15;
    //start_x = (preview_w - window_w)/2
    //start_y = (preview_h - window_h)/2
    start_x = 1024*(1-0.15)/2;
    start_y = 1024*(1-0.15)/2;

    SENSORDB("width = %d, height = %d, start_x= %d, start_y= %d\n",
        width_ratio,
        height_ratio,
        start_x,
        start_y
    ...
    S5K4ECGX_write_cmos_sensor(0x002A,	       0x0294);
    S5K4ECGX_write_cmos_sensor(0x0F12,	      start_x);	//#REG_TC_AF_FstWinStartX
    S5K4ECGX_write_cmos_sensor(0x0F12,	      start_y);	//#REG_TC_AF_FstWinStartY
    S5K4ECGX_write_cmos_sensor(0x0F12,	  width_ratio);	//#REG_TC_AF_FstWinSizeX
    S5K4ECGX_write_cmos_sensor(0x0F12,	 height_ratio);	//#REG_TC_AF_FstWinSizeY
    S5K4ECGX_write_cmos_sensor(0x0F12,	      start_x);	//#REG_TC_AF_ScndWinStartX
    S5K4ECGX_write_cmos_sensor(0x0F12,	      start_y);	//#REG_TC_AF_ScndWinStartY
    S5K4ECGX_write_cmos_sensor(0x0F12,	  width_ratio);	//#REG_TC_AF_ScndWinSizeX
    S5K4ECGX_write_cmos_sensor(0x0F12,	 height_ratio);	//#REG_TC_AF_ScndWinSizeY
    S5K4ECGX_write_cmos_sensor(0x0F12,	       0x0001);	//#REG_TC_AF_WinSizesUpdated
...
//update zone[]
static void S5K4ECGX_FOCUS_Update_Zone(void)
{
    //send update zone cmd to firmware
    S5K4ECGX_write_cmos_sensor(0xFCFC,0xD000);					 
    S5K4ECGX_write_cmos_sensor(0x0028,0x7000);  //TODO:??	
    S5K4ECGX_write_cmos_sensor(0x002A,0x02A4);  //REG_TC_AF_WinSizesUpdated
    S5K4ECGX_write_cmos_sensor(0x0F12,0x0001);	
}
...
//set constant focus
static void S5K4ECGX_FOCUS_Constant_Focus(void)
{
    SENSORDB("S5K4ECGX_FOCUS_Constant_Focus\n");

    S5K4ECGX_write_cmos_sensor(0xFCFC,0xD000);					 
    S5K4ECGX_write_cmos_sensor(0x0028,0x7000);  //TODO:??	
    S5K4ECGX_write_cmos_sensor(0x002A,0x028C);	
    S5K4ECGX_write_cmos_sensor(0x0F12,0x0006);	//REG_TC_AF_AfCmd 	0x06 : Continuous - Single AF command
    mdelay(33);
}
static void S5K4ECGX_FOCUS_Single_Focus()
{
    UINT32 state;
    UINT32 iteration = 100; //time out

    SENSORDB("S5K4ECGX_FOCUS_Single_Focus\n");
    // The constant AF of 4EC is to triiger AFS first and keep mornitor the scene change
    // Our aaa_hal_yuv is to trigger AFS followed by AFC
    // Therefore, use AFC instead of AFS, and disable original AFC

//    S5K4ECGX_FOCUS_Update_Zone();
//    S5K4ECGX_FOCUS_Update_Zone();
    ...
    S5K4ECGX_write_cmos_sensor(0x0F12,0x0006);	//REG_TC_AF_AfCmd 	0x06 : continuous
    mdelay(33);
    SENSORDB("S5K4ECGX_FOCUS_Single_Focus end\n");
    do {
        S5K4ECGX_write_cmos_sensor(0xFCFC,0x7000);					 
        state = S5K4ECGX_read_cmos_sensor(0x2EEE);
        S5K4ECGX_write_cmos_sensor(0xFCFC,0xD000);					 
	SENSORDB("state=0x%x\n",state);	
        ...
        if (--iteration == 0)
        {
            SENSORDB("S5K4ECGX_FOCUS_Cancel_Focus [time out!!]\n");
            break;
        }
    } while( (state!=0x1) && (state!=0x3));
    mdelay(33);
}


static void S5K4ECGX_FOCUS_Cancel_Focus()
{
    UINT32 state;
    UINT32 iteration = 100; //time out

     SENSORDB("S5K4ECGX_FOCUS_Cancel_Focus\n");

    //send idle command to firmware
    S5K4ECGX_write_cmos_sensor(0xFCFC,0xD000);					 
    S5K4ECGX_write_cmos_sensor(0x0028,0x7000);					 
    S5K4ECGX_write_cmos_sensor(0x002A,0x028C);					 
    S5K4ECGX_write_cmos_sensor(0x0F12,0x0001);	//REG_TC_AF_AfCmd 	0x01 : ABORT - Aborts currently executing command (except INIT command)
    do {
        S5K4ECGX_write_cmos_sensor(0xFCFC,0x7000);					 
        state = S5K4ECGX_read_cmos_sensor(0x2EEE);
        S5K4ECGX_write_cmos_sensor(0xFCFC,0xD000);					 
...
static void S5K4ECGX_FOCUS_Get_AF_Status(UINT32 *pFeatureReturnPara32)
{
	
// 1 Hal3AYuv::getAFDone() query
// 2 draw focus rectangle query
    S5K4ECGX_write_cmos_sensor(0xFCFC,0x7000);					 
    UINT32 state = S5K4ECGX_read_cmos_sensor(0x2EEE);
    S5K4ECGX_write_cmos_sensor(0xFCFC,0xD000);					 

//0x03: Low confidence
//0x04: canceled

    SENSORDB("S5K4ECGX_FOCUS_Get_AF_Status=0x%x\n", state);
    ...
    else if(0x0001 == state)
    {
        *pFeatureReturnPara32 = SENSOR_AF_FOCUSING;
		
    }
    else if(0x0002 == state)
    {
    ...
    else
    {
     ...
     SENSORDB("S5K4ECGX_FOCUS_Get_AF_Status return %d\n", *pFeatureReturnPara32);
...
*/		     
        ...
        case SENSOR_FEATURE_MOVE_FOCUS_LENS:
            //SENSORDB("S5K4ECGX_FOCUS_Move_to %d\n", *pFeatureData16);
            S5K4ECGX_FOCUS_Move_to(*pFeatureData16);
            break;
        case SENSOR_FEATURE_GET_AF_STATUS:
            S5K4ECGX_FOCUS_Get_AF_Status(pFeatureReturnPara32);
            *pFeatureParaLen=4;
            break;
        case SENSOR_FEATURE_GET_AF_INF:
            S5K4ECGX_FOCUS_Get_AF_Inf(pFeatureReturnPara32);
            *pFeatureParaLen=4;            
            break;
        case SENSOR_FEATURE_GET_AF_MACRO:
            S5K4ECGX_FOCUS_Get_AF_Macro(pFeatureReturnPara32);
            *pFeatureParaLen=4;            
            break;                
        case SENSOR_FEATURE_SET_AF_WINDOW:
            S5K4ECGX_FOCUS_Set_AF_Window(*pFeatureData32);
            break;
        case SENSOR_FEATURE_SINGLE_FOCUS_MODE:
            //Daniel: marked because the constant AF will trigger AFS onece
            S5K4ECGX_FOCUS_Single_Focus();
            break;	
