...
//    AP_CFG_CUSTOM_FILE_CUSTOM2_LID,
    ...
    AP_CFG_CUSTOM_FILE_CCI_SW_LID,  //paul
...
#define AP_CFG_CUSTOM_FILE_CCI_SW_LID_VERNO			"000"  //paul
#define AP_CFG_CUSTOM_FILE_CUST_IN_SW_LID_VERNO			"000"  //paul
#define AP_CFG_CUSTOM_FILE_CUST_EX_SW_LID_VERNO			"000"  //paul
#define AP_CFG_CUSTOM_FILE_HW_LID_VERNO				"000"  //paul
#define AP_CFG_CUSTOM_FILE_FTM_TEST_RESULT_LID_VERNO		"000"  //paul
#define AP_CFG_CUSTOM_FILE_OP_LID_VERNO				"000"  //paul
#define AP_CFG_CUSTOM_FILE_P_SENSOR_THRESHOLD_RESULT_LID_VERNO  "000"  //Louis
