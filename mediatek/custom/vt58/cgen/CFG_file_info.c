...
FileName aBackupToBinRegion[]=
{
	...
	{"CCI_SW",AP_CFG_CUSTOM_FILE_CCI_SW_LID},
        {"P_SENSOR_THRESHOLD",AP_CFG_CUSTOM_FILE_FTM_TEST_RESULT_LID},
	{"CUST_EX_SW",AP_CFG_CUSTOM_FILE_CUST_EX_SW_LID},
	{"CUST_IN_SW",AP_CFG_CUSTOM_FILE_CUST_IN_SW_LID},
	{"HW",AP_CFG_CUSTOM_FILE_HW_LID},
	{"FTM_TEST_RESULT",AP_CFG_CUSTOM_FILE_FTM_TEST_RESULT_LID},
	{"OP",AP_CFG_CUSTOM_FILE_OP_LID},
...
#endif
  NULL,//AP_CFG_CUSTOM_FILE_CCI_SW_LID  //paul
  NULL,//AP_CFG_CUSTOM_FILE_CUST_IN_SW_LID
  NULL,//AP_CFG_CUSTOM_FILE_CUST_EX_SW_LID
  NULL,//AP_CFG_CUSTOM_FILE_HW_LID
  NULL,//AP_CFG_CUSTOM_FILE_FTM_TEST_RESULT_LID
  NULL,//AP_CFG_CUSTOM_FILE_OP_LID
