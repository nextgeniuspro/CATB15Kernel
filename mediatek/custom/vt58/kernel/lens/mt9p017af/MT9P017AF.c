/************************************
 * For VT58 main camera lens driver *
 ************************************/
...
{
/*Add for enable Auto focus fuction start*/
    MT9P017_write_cmos_sensor(0x30f0,0x8000);
/*Add for enable Auto focus fuction end*/
...
/*Add for uses new I2C driver add function start*/
...
/*Add for uses new I2C driver add function end*/

/*remove for old version start*/
...
{
    /*copy from FM50AF.c for I2C init function*/
