...
char *CCI_UBOOT_PLATFORM_BOOTARG;
//add for check HW ID2
//char *CCI_UBOOT_LCM_CHECK_BOOTARG;
//add for check HW ID2
//[Paul Add End]<<
...
//[Paul Add Start]>>
void cci_get_bootarg_form_platform_id();
//[Paul Add End]<<
#if 0
...
//[Paul Add Start]>>
cci_get_bootarg_form_platform_id();
strlen += sprintf(commandline, "%s%s%s", commandline, " cust_project=", CCI_UBOOT_PLATFORM_BOOTARG);
//add for check HW ID2
//strlen += sprintf(commandline, "%s%s%s", commandline, " cust_LCM_check=", CCI_UBOOT_LCM_CHECK_BOOTARG);
//add for check HW ID2
strlen += sprintf(commandline, "%s%s%d", commandline, " cust_bootreason=", g_boot_arg->boot_reason+1);
//[Paul Add End]<<
    /**
...
void cci_get_bootarg_form_platform_id(){
    ...
    {
    	if(cci_platform_is_dvt()){
        	CCI_UBOOT_PLATFORM_BOOTARG = "DVT.BAND_1_8";
        	printf("*************************************************\n");
        	printf("*  CCI-Uboot platform bootargs= %s              *\n",CCI_UBOOT_PLATFORM_BOOTARG);
        	printf("*************************************************\n");	
    	}
        else if(cci_platform_is_pvt()){
        	CCI_UBOOT_PLATFORM_BOOTARG = "PVT.BAND_1_8";
        	printf("*************************************************\n");
        	printf("*  CCI-Uboot platform bootargs= %s              *\n",CCI_UBOOT_PLATFORM_BOOTARG);
        	printf("*************************************************\n");			
    	}
	...
	{
		CCI_UBOOT_PLATFORM_BOOTARG = "UNKNOWN_PHASE.BAND_1_8";
        	printf("*************************************************\n");
        	printf("*  CCI-Uboot platform bootargs= %s              *\n",CCI_UBOOT_PLATFORM_BOOTARG);
        	printf("*************************************************\n");			
	}
    ...
    {
    	if(cci_platform_is_dvt()){
        	CCI_UBOOT_PLATFORM_BOOTARG = "DVT.BAND_2_5";
        	printf("*************************************************\n");
        	printf("*  CCI-Uboot platform bootargs= %s              *\n",CCI_UBOOT_PLATFORM_BOOTARG);
        	printf("*************************************************\n");	
    	}
        else if(cci_platform_is_pvt()){
        	CCI_UBOOT_PLATFORM_BOOTARG = "PVT.BAND_2_5";
        	printf("*************************************************\n");
        	printf("*  CCI-Uboot platform bootargs= %s              *\n",CCI_UBOOT_PLATFORM_BOOTARG);
        	printf("*************************************************\n");			
    	}
	...
	{
		CCI_UBOOT_PLATFORM_BOOTARG = "UNKNOWN_PHASE.BAND_2_5";
        	printf("*************************************************\n");
        	printf("*  CCI-Uboot platform bootargs= %s              *\n",CCI_UBOOT_PLATFORM_BOOTARG);
        	printf("*************************************************\n");			
	}
    ...
    {
		if(cci_platform_is_dvt()){
        	CCI_UBOOT_PLATFORM_BOOTARG = "DVT.UNKNOWN_BAND";
        	printf("*************************************************\n");
        	printf("*  CCI-Uboot platform bootargs= %s              *\n",CCI_UBOOT_PLATFORM_BOOTARG);
        	printf("*************************************************\n");	
    	}
        else if(cci_platform_is_pvt()){
        	CCI_UBOOT_PLATFORM_BOOTARG = "PVT.UNKNOWN_BAND";
        	printf("*************************************************\n");
        	printf("*  CCI-Uboot platform bootargs= %s              *\n",CCI_UBOOT_PLATFORM_BOOTARG);
        	printf("*************************************************\n");			
    	}
	...
	{
		CCI_UBOOT_PLATFORM_BOOTARG = "UNKNOWN_PHASE.UNKNOWN_BAND";
	}
	//CCI_UBOOT_PLATFORM_BOOTARG = "DVT.BAND_2_5";
    }
    /*if(cci_platform_is_pvt()){
...
//add for check HW ID2
//    CCI_UBOOT_LCM_CHECK_BOOTARG = "Tienma";
//    if(check_hwid2_function()){
//	CCI_UBOOT_LCM_CHECK_BOOTARG = "Tienma"; 
//    }else{	
//	CCI_UBOOT_LCM_CHECK_BOOTARG = "Truly";
//    }
//add for check HW ID2

    //CCI_UBOOT_PLATFORM_BOOTARG = "MP";
#if 1 /* ***** CCI BSP.SYS ***** */
/* Change CCI_UBOOT_PLATFORM_BOOTARG here if needed */
#endif /* ***** CCI BSP.SYS ***** */
}
//[Paul Add End]<<
