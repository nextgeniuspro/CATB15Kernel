...
//[20121025+BW - add hw id pin init]>>
void cci_hw_id_pin_init()
{
    mt_set_gpio_mode(GPIO_HW_ID1, GPIO_MODE_00);
    mt_set_gpio_dir(GPIO_HW_ID1, GPIO_DIR_IN);
    mt_set_gpio_pull_enable(GPIO_HW_ID1, GPIO_PULL_DISABLE);
    mt_set_gpio_mode(GPIO_HW_ID2, GPIO_MODE_00);
    mt_set_gpio_dir(GPIO_HW_ID2, GPIO_DIR_IN);
    mt_set_gpio_pull_enable(GPIO_HW_ID2, GPIO_PULL_DISABLE);
    mt_set_gpio_mode(GPIO_HW_ID3, GPIO_MODE_00);
    mt_set_gpio_dir(GPIO_HW_ID3, GPIO_DIR_IN);
    mt_set_gpio_pull_enable(GPIO_HW_ID3, GPIO_PULL_DISABLE);
    mt_set_gpio_mode(GPIO_HW_ID4, GPIO_MODE_00);
    mt_set_gpio_dir(GPIO_HW_ID4, GPIO_DIR_IN);
    mt_set_gpio_pull_enable(GPIO_HW_ID4, GPIO_PULL_DISABLE);
    mt_set_gpio_mode(GPIO_HW_ID5, GPIO_MODE_00);
    mt_set_gpio_dir(GPIO_HW_ID5, GPIO_DIR_IN);
    mt_set_gpio_pull_enable(GPIO_HW_ID5, GPIO_PULL_DISABLE);
    GPIOLOG("*************************************************************\n");
    GPIOLOG("*    HW ID PIN init function                                *\n");
    GPIOLOG("*    HW ID pin = %d, Mode = %d, DIR = %d, Pull= %d          *\n",GPIO_HW_ID1,mt_get_gpio_mode(GPIO_HW_ID1),mt_get_gpio_dir(GPIO_HW_ID1),mt_get_gpio_pull_enable(GPIO_HW_ID1));
    GPIOLOG("*    HW ID pin = %d, Mode = %d, DIR = %d, Pull= %d          *\n",GPIO_HW_ID2,mt_get_gpio_mode(GPIO_HW_ID2),mt_get_gpio_dir(GPIO_HW_ID2),mt_get_gpio_pull_enable(GPIO_HW_ID2));
    GPIOLOG("*    HW ID pin = %d, Mode = %d, DIR = %d, Pull= %d          *\n",GPIO_HW_ID3,mt_get_gpio_mode(GPIO_HW_ID3),mt_get_gpio_dir(GPIO_HW_ID3),mt_get_gpio_pull_enable(GPIO_HW_ID3));
    GPIOLOG("*    HW ID pin = %d, Mode = %d, DIR = %d, Pull= %d          *\n",GPIO_HW_ID4,mt_get_gpio_mode(GPIO_HW_ID4),mt_get_gpio_dir(GPIO_HW_ID4),mt_get_gpio_pull_enable(GPIO_HW_ID4));
    GPIOLOG("*    HW ID pin = %d, Mode = %d, DIR = %d, Pull= %d          *\n",GPIO_HW_ID5,mt_get_gpio_mode(GPIO_HW_ID5),mt_get_gpio_dir(GPIO_HW_ID5),mt_get_gpio_pull_enable(GPIO_HW_ID5));
    GPIOLOG("*************************************************************\n");
    return 0;
}
//[20121025+BW - add hw id pin init]<<
