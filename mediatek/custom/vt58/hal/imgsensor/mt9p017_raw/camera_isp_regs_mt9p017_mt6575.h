...
Shading:{
    {set:{//00 Preview
        0x00000000,0x00000000,0x00000000,0x00000000,0x00000000,0x00000000,0x10000000,0x90409030,0x00442640,0x00420033,0x20202020,
    }},
    {set:{//01 Capture
        0x00000000,0x00000000,0x00000000,0x00000000,0x00000000,0x00000000,0x10000000,0xF050F03C,0x00484020,0x0052003F,0x20202020,
    }},
    {set:{//02
...
EE:{//EE
    ...
    {set:{//05 Capture ISO100 (middle sharpness)
        0x00000008, 0x0032322D, 0x00500123, 0x0384183C, 0x0258F864, 0x003CFEDC, 0xFFFFFF0B, 
    }},
    {set:{//06 Capture ISO200 (middle sharpness)
        0x00000008, 0x0032322D, 0x003C0123, 0x0320183C, 0x01F4F864, 0x003CFEDC, 0xFFFFFF0B, 
    }},
...
Saturation:{
    {set:{//00 (middle saturation)
        0x00000709, 0x1020E0F0, 0x2C464846, 0x2E000000, 0xFF00FF00, 0x00000000, 0x00000000, 0x001E140A, 
    }},
...
CCM:{
    {set:{//00
        0x012C046B, 0x003F04AD, 0x01830020, 0x043404A2, 0x01D60000, 
    }},
    {set:{//01
        0x01BB04BB, 0x000004A6, 0x017C002A, 0x041304D3, 0x01E60000, 
    }},
    {set:{//02
        //0x016F04AE, 0x003F0497, 0x01720025, 0x0414049E, 0x01B20000, 
		0x018004C8, 0x0048044B, 0x0156040B, 0x04120472, 0x01840000
    }}
},
Gamma:{
    {set:{//00
