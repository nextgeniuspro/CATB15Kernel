...
_custom_usb_rc := $(MTK_ROOT_CONFIG_OUT)/init.usb.rc
ifneq ($(wildcard $(_custom_usb_rc)),)
PRODUCT_COPY_FILES += $(_custom_usb_rc):root/init.usb.rc
endif
...
ifeq ($(MTK_SHARED_SDCARD),yes)
  PRODUCT_COPY_FILES += $(MTK_ROOT_CONFIG_OUT)/init.sdcard.rc:root/init.sdcard.rc
endif
