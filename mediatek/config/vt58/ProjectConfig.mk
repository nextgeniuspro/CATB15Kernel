...
CUSTOM_KERNEL_IMGSENSOR=mt9p017_raw ov7692_yuv
...
CUSTOM_KERNEL_MAIN_LENS=mt9p017af
#Vince add end
#paul add start
CUSTOM_KERNEL_CCI_DRV_COMMON=cci_drv_common
#paul add end
CUSTOM_KERNEL_RTC=rtc
CUSTOM_KERNEL_SOUND=amp_6329pmic_spk
CUSTOM_KERNEL_SUB_LENS=dummy_lens
#CUSTOM_KERNEL_TOUCHPANEL=ft5206
CUSTOM_KERNEL_TOUCHPANEL=ektf2132
CUSTOM_KERNEL_USB=mt6577
CUSTOM_KERNEL_VIBRATOR=vibrator
CUSTOM_LK_LCM=hx8369_6575_dsi
CUSTOM_MODEM=cci77_vt58_cu_jb_hspa
...
MTK_PRODUCT_LOCALES=en_GB en_US fr_FR it_IT es_ES de_DE nl_NL cs_CZ pl_PL ru_RU nb_NO da_DK el_GR tr_TR pt_PT rm_CH sv_SE bg_BG ca_ES fi_FI hi_IN hr_HR hu_HU iw_IL lt_LT lv_LV ro_RO sk_SK sl_SI sr_RS uk_UA ar_EG fa_IR af_ZA zu_ZA zh_TW zh_CN es_US ko_KR pt_BR hdpi
MTK_QVGA_LANDSCAPE_SUPPORT=no
MTK_RAT_BALANCING=no
MTK_RAT_WCDMA_PREFERRED=yes
MTK_RCSE_SUPPORT=no
MTK_RELEASE_PACKAGE=rel_customer_operator_cu rel_customer_basic
...
MTK_SDIO_DATA_DELAY_SETTINGS_SUPPORT=yes
...
OPTR_SPEC_SEG_DEF=GENERIC_SPECDEFAULT_SEGDEFAULT
PLATFORM_VERSION_V4_1_2=yes
